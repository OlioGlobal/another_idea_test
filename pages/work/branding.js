...
const LOGO_DATA = [
  [
    "/",
    "/assets/logoimg/18 East.png",
    "",
    "/assets/logopdf/18 East_Merlin Group.pdf",
  ],
  ...
  [
    "/",
    "/assets/logoimg/Falcon.png",
    "",
    "/assets/logopdf/hiranandani falcon identity.pdf",
  ],
  [
    "/",
  ...
  // ["/", "/assets/logoimg/Trend.png", "", "/assets/logopdf/TrandINN_PDF.pdf"],
  ...
  [
    "/",
    "/assets/logoimg/Westbay.png",
    "",
    "/assets/logopdf/Westbay_Transcon.pdf",
  ],
  [
    "/",
    "/assets/logoimg/Westward.png",
    "",
    "/assets/logopdf/Westward_Vraj.pdf",
  ],
...
const STATIONERY_DATA = [
  ...
  [
    "/",
    "/assets/stationeryimg/LOGO_HIRANANDANI FALCON.jpg",
    "HIRANANDANI FALCON",
...
export default function Branding(props) {
  return (
    <Work>
      <WorkHero
        title="Branding"
        heroCopy="We help co-create brands, not only advertise your projects. Consider us the Google Maps equivalent for your brand.
      ...
      <div className="List-container">
        ...
        <div className="List-wrapper">
          <GallaryList
            parentProp={props}
            gallaryData={LOGO_DATA}
            LIST_NAME={"LOGO"}
            pageColor={colorIndex[0]}
          />
        </div>
      </div>
      ...
      <div className="List-container">
        ...
        <div className="List-wrapper">
          <GallaryList
            parentProp={props}
            gallaryData={STATIONERY_DATA}
            LIST_NAME={"STATIONERY"}
            pageColor={colorIndex[0]}
          />
        </div>
      </div>
      ...
      <div className="List-container">
        ...
        <div className="List-wrapper">
          <GallaryList
            parentProp={props}
            gallaryData={GUIDELINES_DATA}
            LIST_NAME={"GUIDELINES"}
            pageColor={colorIndex[0]}
          />
        </div>
      </div>
