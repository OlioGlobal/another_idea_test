...
export function StrategyListItem(prop) {
  return (
    <li className="ListIconTitleText-listItem">
      <div
        className="ListIconTitleText-icon"
        style={{
          WebkitMask:
            'url("/assets/expertise-picto-ux.svg") center center no-repeat',
          transform: "translate3d(0px, 0px, 0px)",
          opacity: 1,
        }}
      ></div>
      <h2 className="ListIconTitleText-listItemTitle">{prop.title}</h2>
      <div className="ListIconTitleText-listItemText">{prop.text}</div>
    </li>
  );
}
  ...
  return (
    <Work>
      <WorkHero
        ...
        heroCopy={
          <>
            How we can empower your Teams
            <br />
            The Credo Range of Skilling Workshops
          </>
        }
      />
      ...
      <div className="Workshops-video">
        <div className="Workshops-video-wrapper">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/-C5POWufMQ8?controls=0&mute=1&autoplay=1"
        ...
        <div className="ListIconTitleText-wrapper">
          <ul className="ListIconTitleText-list">
            <StrategyListItem
              title={
                <>
                  The Art Of Connecting before Selling.
                  <br />
                  Sales Empowering Workshops.
                </>
              }
              text={
                <>
            ...
            <StrategyListItem
              title={
                <>
                  Upgrading performance in areas beyond Sales.
                  <br />
                  Expert Workshops.
                </>
              }
            ...
            <StrategyListItem
              title={
                <>
                  ...
                  <br />
                  HR Attraction-Induction-Retention Workshops.
                </>
              }
              text={
                <>
                  <ul className="Campaign-list">
                    ...
                    <li>
                      Coaching for Talent Empowerment – from hiring to retaining
                    </li>
                  </ul>
                </>
              }
